...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    loadCurrentUser();
    // Listen for forced logout events dispatched by the API layer
    // (e.g. refresh token expired mid-session).
    const handleForcedLogout = () => setUser(null);
    window.addEventListener("fluxora:logout", handleForcedLogout);
    return () =>
      window.removeEventListener("fluxora:logout", handleForcedLogout);
  }, [loadCurrentUser]);
